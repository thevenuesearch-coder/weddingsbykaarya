...
import JourneyProcess from "./JourneyProcess";
import KaaryaPromise from "./KaaryaPromise";
        ...
        <div className="mx-auto max-w-[1100px]">
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundColor: "rgba(201,164,107,0.22)",
              }}
            />
                ...
                return (
                  ...
                  >
                    ...
                    <motion.span
                      ...
                      style={{
                        backgroundColor: "#C9A46B",
                        boxShadow: "0 0 0 6px rgba(78,30,39,1)",
                      }}
                    ...
                    <Reveal
                      className={`pl-16 md:pl-0 md:w-[45%] ${
                        left
                    ...
                    >
                      ...
                      <span
                        className="font-serif-display text-6xl md:text-7xl block leading-none"
                        style={{
                          color: "rgba(201,164,107,0.35)",
                        }}
                      >
                        {j.phase}
                      </span>
                      ...
                      <span
                        className="inline-block mt-2 text-xs tracking-[0.35em] uppercase"
                        style={{
                          color: "#C9A46B",
                        }}
                      >
                      ...
                      <h3
                        className="font-serif-display text-2xl md:text-4xl mt-3 mb-3"
                        style={{
                          color: "#F8F5EF",
                        }}
                      >
